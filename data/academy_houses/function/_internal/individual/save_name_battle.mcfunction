# Sauvegarder le nom du joueur pour les batailles gagnées
...
$execute store result storage academy_houses:temp score int 1 run scoreboard players get @s battle_won
$data modify storage academy_houses:rankings battle.rank$(rank) set value {name:"",score:0}
$data modify storage academy_houses:rankings battle.rank$(rank).name set from storage academy_houses:temp current_name
$data modify storage academy_houses:rankings battle.rank$(rank).score set from storage academy_houses:temp score